...
import serviceImplementation.RuleBasedAdapterController;

	 
public class HttpServerRuleBasedAdapter {
	...
	private static void startMicroserviceOnSpecificPort(int port, String passphrase) throws Exception {
		...
		jerseyServlet.setInitParameter("jersey.config.server.provider.classnames", RuleBasedAdapterController.class.getCanonicalName());
	...
	private static Server initializeSecureServer() {
	   ...
	   sslContextFactory.setKeyStorePath("D:\\Arbeit\\Bantel\\Masterarbeit\\Implementierung\\ForecastingTool\\Services\\LoginServices\\CustomLoginService\\LoginServiceKeystore.jks");
	   sslContextFactory.setKeyManagerPassword("LoginService_safetyFirst");
	   sslContextFactory.setKeyStorePassword("LoginService_safetyFirst"); 
