...
import serviceImplementation.EvaluationPreparationController;
 
public class HttpServerEvaluationPreparationBantel {
	...
	private static void startMicroserviceOnSpecificPort(int port, String passphrase) throws Exception {
		...
		jerseyServlet.setInitParameter("jersey.config.server.provider.classnames", EvaluationPreparationController.class.getCanonicalName());
	...
	private static Server initializeSecureServer() {
        ...
        sslContextFactory.setKeyStorePath("D:\\Arbeit\\Bantel\\Masterarbeit\\Implementierung\\ForecastingTool\\Services\\ForecastingServices\\RuleBasedService\\RuleBasedServiceKeystore.jks");
        //sslContextFactory.setTrustStorePath("D:\\Arbeit\\Bantel\\Masterarbeit\\Server\\SSH\\PuttyKeyGen\\RuleBasedServer_Private.ppk");
        //sslContextFactory.setTrustStorePassword("RuleBasedServer1$Tsuper");
        sslContextFactory.setKeyManagerPassword("RuleBasedService_safetyFirst");
        sslContextFactory.setKeyStorePassword("RuleBasedService_safetyFirst"); 
        ...
        httpConnector.setName("insecureConnector");
        httpConnector.setPort(8300);
