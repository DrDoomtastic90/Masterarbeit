...
import serviceImplementation.ANNController;

 
public class HttpServerANN {
	...
	private static void startMicroserviceOnSpecificPort(int port, String passphrase) throws Exception {
		...
		jerseyServlet.setInitParameter("jersey.config.server.provider.classnames", ANNController.class.getCanonicalName());
