...
import serviceImplementation.OutlierHandlingController;

 
public class HttpServerOutlierHandling {
	...
	private static void startMicroserviceOnSpecificPort(int port, String passphrase) throws Exception {
		...
		jerseyServlet.setInitParameter("jersey.config.server.provider.classnames", OutlierHandlingController.class.getCanonicalName());
