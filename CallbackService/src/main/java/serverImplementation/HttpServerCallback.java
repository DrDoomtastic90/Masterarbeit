...
import serviceImplementation.CallbackServiceController;
 
public class HttpServerCallback {
	...
	private static void startMicroserviceOnSpecificPort(int port, String passphrase) throws Exception {
		...
		jerseyServlet.setInitParameter("jersey.config.server.provider.classnames", CallbackServiceController.class.getCanonicalName());
