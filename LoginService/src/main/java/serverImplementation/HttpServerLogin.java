...
import serviceImplementation.LoginController;
...
public class HttpServerLogin {
	...
	private static void startMicroserviceOnSpecificPort(int port, String passphrase) throws Exception {
		...
		jerseyServlet.setInitParameter("jersey.config.server.provider.classnames", LoginController.class.getCanonicalName());
