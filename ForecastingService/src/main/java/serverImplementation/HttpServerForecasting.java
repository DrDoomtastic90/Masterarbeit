...
import serviceImplementation.ServiceController;

	 
public class HttpServerForecasting {
	...
	public static void main(String[] args) throws Exception {
		numberOfInstances = 0;
		//System.setProperty("javax.net.ssl.trustStore","D:\\Arbeit\\Bantel\\Masterarbeit\\Implementierung\\ForecastingTool\\Services\\LoginServices\\CustomLoginService\\LoginServiceKeystore.jks");
		//System.setProperty("javax.net.ssl.trustStorePassword","LoginService_safetyFirst");
		if(args.length>0) {
	...
	private static void startMicroserviceOnSpecificPort(int port, String passphrase) throws Exception {
		...
		jerseyServlet.setInitParameter("jersey.config.server.provider.classnames", ServiceController.class.getCanonicalName());
	...
	private static Server initializeSecureServer() {
	   ...
	   sslContextFactory.setKeyStorePath("D:\\Arbeit\\Bantel\\Masterarbeit\\Implementierung\\ForecastingTool\\Services\\ForecastingServices\\CombinedForecastingService\\ForecastingServiceKeystore.jks");
	   sslContextFactory.setKeyManagerPassword("ForecastingService_safetyFirst");
	   sslContextFactory.setKeyStorePassword("ForecastingService_safetyFirst"); 
