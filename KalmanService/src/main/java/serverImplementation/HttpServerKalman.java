...
import serviceImplementation.KalmanController;

 
public class HttpServerKalman {
	...
	private static void startMicroserviceOnSpecificPort(int port, String passphrase) throws Exception {
		...
		jerseyServlet.setInitParameter("jersey.config.server.provider.classnames", KalmanController.class.getCanonicalName());
