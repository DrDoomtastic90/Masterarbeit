...
import serviceImplementation.ExponentialSmoothingController;

 
public class HttpServerExponentialSmoothing {
	...
	private static void startMicroserviceOnSpecificPort(int port, String passphrase) throws Exception {
		...
		jerseyServlet.setInitParameter("jersey.config.server.provider.classnames", ExponentialSmoothingController.class.getCanonicalName());
