...
import serviceImplementation.CampaignHandlingController;

 
public class HttpServerCampaignHandling {
	...
	private static void startMicroserviceOnSpecificPort(int port, String passphrase) throws Exception {
		...
		jerseyServlet.setInitParameter("jersey.config.server.provider.classnames", CampaignHandlingController.class.getCanonicalName());
