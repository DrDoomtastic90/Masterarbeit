...
import serviceImplementation.ARIMAAdapterController;
	 
public class HttpServerARIMAAdapter {
	...
	private static void startMicroserviceOnSpecificPort(int port, String passphrase) throws Exception {
		...
		jerseyServlet.setInitParameter("jersey.config.server.provider.classnames", ARIMAAdapterController.class.getCanonicalName());
