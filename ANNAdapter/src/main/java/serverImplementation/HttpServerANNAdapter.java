...
import serviceImplementation.ANNAdapterController;
	 
public class HttpServerANNAdapter {
	...
	private static void startMicroserviceOnSpecificPort(int port, String passphrase) throws Exception {
		...
		jerseyServlet.setInitParameter("jersey.config.server.provider.classnames", ANNAdapterController.class.getCanonicalName());
