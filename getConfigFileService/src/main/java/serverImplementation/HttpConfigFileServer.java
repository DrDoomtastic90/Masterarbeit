...
import serviceImplementation.ConfigFileController;
	 
public class HttpConfigFileServer {
	...
	private static void startMicroserviceOnSpecificPort(int port, String passphrase) throws Exception {
		...
		jerseyServlet.setInitParameter("jersey.config.server.provider.classnames", ConfigFileController.class.getCanonicalName());
